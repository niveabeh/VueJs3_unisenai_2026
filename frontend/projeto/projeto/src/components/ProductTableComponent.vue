<template>
    ...
    <table class="table">
        ...
        <tr v-for="produto in produtosFiltrados" :key="produto.id">
            ...
            <td>
                <button class="btn btn-warning" @click="editar(produto)">Editar</button>
                <button class="btn btn-danger" @click="remover(produto.id)">Excluir</button>
            </td>
        </tr>
    </table>
</template>
...
const emit = defineEmits(["editarProduto"])
